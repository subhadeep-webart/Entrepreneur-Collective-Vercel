...
const PostReaction = () => {
    return (
        <div className="flex h-5 items-center space-x-4 text-small w-full gap-2">
            <div className="w-full"><ReactionButton /></div>
            <Divider orientation="vertical" />
            <div className="w-full flex justify-center items-center">
                <CustomButton className="bg-transparent w-40">
                    <Icons.MessageCircle size={18} className="text-form-text"/>
                    <span className="inline-block ml-2 text-soft-black text-base font-normal">Comment</span>
                </CustomButton>
            </div>
            <Divider orientation="vertical" />
            <div className="w-full flex justify-end">
                <CustomButton className="bg-transparent w-20">
                    ...
                    <span className="inline-block ml-2 text-soft-black text-base font-normal">Share</span>
                </CustomButton>
            </div>
        </div>
    )
