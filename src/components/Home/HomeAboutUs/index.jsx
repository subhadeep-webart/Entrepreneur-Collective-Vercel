    ...
    <div className="container !mt-14 !mb-20">
      <div className="flex gap-6">
        <div className="!mt-4 flex flex-col">
          <h3 className="font-normal text-3xl text-foreground !mb-5">
            About us
          </h3>
          <h4 className="font-semibold text-5xl text-foreground !mb-6 leading-14">
            ...
            Innovation Starts with the Right Connection
          </h4>
          <p className="font-normal text-base text-foreground !mb-11 leading-7">
            ...
            We are a dedicated hub for business owners and high-level experts to
            harness the full potential of their networks. The Entrepreneurs
            Collaborative serves as a trusted ecosystem where genuine, authentic
            connections thrive and projects move from concept to reality.
          </p>
        ...
        <div className="">
          <h3 className="font-bold text-xl text-almost-black !mb-9">
            Upcoming
          </h3>
          <AIToolsSection />
        </div>
