    ...
    return (
        <>
            ...
            <div className="grid grid-cols-12 gap-7 w-full container">
                ...
                <div className="col-span-4 w-full !space-y-9">
                    <div className="w-full bg-almost-gray flex flex-col gap-7 justify-center h-[326px] !px-9">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-white font-normal">admin@entrepreneurcollective.com</span>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-white font-normal">Aliquam nisl eros, bibendum non/175 Road</span>
                            </div>
                        </div>
                    </div>
                    <div className="w-full">
                        <Image src={PUBLIC_IMAGES.ContactUsMap} height={372} width={421} alt="Contact Us Map" />
                    </div>
                </div>
            </div>
        </>
