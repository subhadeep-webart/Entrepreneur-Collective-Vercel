...
import ChooseUsSection from "@/components/AboutUs/ChooseUsSection";
  ...
  return (
    <>
      <div className="flex flex-col gap-2 container">
        <h3 className="text-black text-3xl font-normal text-center">
          Our mission
        </h3>
        <InnerPageSectionHeader
          headerText="Revolutionizing networking for business owners"
