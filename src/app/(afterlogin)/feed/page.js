        ...
        <section className="container after_login_page_section_padding">
            ...
            <div className="grid grid-cols-12 w-full gap-7">
                <div className="col-span-8 flex flex-col gap-10">
                    <PostDisplayCardWrapper headerText={`Integer sagittis sollicitudin ligula. Nulla accumsan eros vel eleifend gravida.`}>
                        <PostCardDisplay />
                        <PostCardDisplay />
                        <PostCardDisplay />
                    </PostDisplayCardWrapper>
                    <PostDisplayCardWrapper headerText={`Donec eu placerat ipsum, sit amet blandit tellus.
